'''
My main bot. Since EC 6 posts comments at a slower rate, I placed its code in tlc_bot.py.
As my README indicates, I posted 1000 valid comments via tranbot47, so...

Total EC from this file: 6 points!
'''
        ...
        if len(not_my_comments) == len(all_comments):
            ...
            for comment in not_my_comments:
                ...
                if len(children) == 0:
                    ...
                    not_yet_replied = True
                    for child in children:
                        if child.author == 'tranbot47':
                            not_yet_replied = False
                    if not_yet_replied == True:
                        comments_without_replies.append(comment)
            ...
            if len(comments_without_replies) > 0:
                ...
                #except praw.exceptions.APIException: #this applies to timeouts too :(
